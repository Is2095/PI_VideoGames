...
import { GET_ALLGAMES, CLEAR_FILTERS, GET_GENRES, FILTER_GENRES, ORDER_RATING, ORDER_ALPHA, GET_PLATFORMS, CLEAN_DETAIL, GET_DETAIL, DATA_ERRORS, GET_GAMES_BY_NAME, CLEAN_SEARCH, CLEAN_GAMES, GET_ALLGAMESBD } from './actionType';
